...
const RU = {
  ...
  'weapon.knife': 'Нож',
  'weapon.bat': 'Бита',
  'weapon.glock': 'Пистолет Глок 19',
  'weapon.ak47': 'Автомат Калашникова 47',
  'weapon.shotgun': 'Дробовик',
  'weapon.m4': 'Штурмовая винтовка М4А1',
  ...
  // ── Quests ────────────────────────────────────────────
  'quest.1':         '🎯 Совершить три преступления',
  'quest.2':         '🚗 Угнать один автомобиль',
  'quest.3':         '💰 Заработать одну тысячу пятьсот долларов пассивно',
  'quest.reward':    'Награда',
  'quest.done':      '✅ Выполнено',
  'quest.claim':     '🎁 Получить {reward}',
  'quest.claimed':   '📜 Задание выполнено! Получено {reward}',
  ...
  'weapon.ak47.name': '⚙️ Автомат Калашникова 47',
...
const HY = {
  ...
  'weapon.knife': 'Դանակ',
  'weapon.bat': 'Բիտա',
  'weapon.glock': 'Ատրճանակ Գլոկ 19',
  'weapon.ak47': 'Ավտոմատ Կալաշնիկով 47',
  'weapon.shotgun': 'Որսորդական հրացան',
  'weapon.m4': 'Գրոհային հրացան Մ4Ա1',
  ...
  // ── Quests ────────────────────────────────────────────
  'quest.1':         '🎯 Կատարել երեք հանցագործություն',
  'quest.2':         '🚗 Առևանգել մեկ ավտոմեքենա',
  'quest.3':         '💰 Վաստակել մեկ հազար հինգ հարյուր դոլար պասիվ եկամուտ',
  'quest.reward':    'Պարգև',
  'quest.done':      '✅ Կատարված է',
  'quest.claim':     '🎁 Ստանալ {reward}',
  'quest.claimed':   '📜 Առաջադրանքը կատարված է: Ստացվել է {reward}',
  ...
  'fam.inv.form.ph':     'Հաշվեհամար (AM123456)...',
  ...
  'weapon.ak47.name': '⚙️ Ավտոմատ Կալաշնիկով 47',

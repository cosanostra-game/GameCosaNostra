...
const RU = {
  ...
  'weapon.pistol.desc': 'Стандартный пистолет. Дает 10% к успеху и предотвращает потерю 5 HP.',
  'weapon.revolver.name': '🔫 Револьвер',
  'weapon.revolver.desc': 'Тяжелый револьвер. Дает 15% к успеху и предотвращает потерю 8 HP.',
  'weapon.shotgun.name': '💥 Дробовик',
  'weapon.shotgun.desc': 'Мощное оружие для ближнего боя. Дает 18% к успеху и предотвращает потерю 12 HP.',
  'weapon.thomson.name': '🔫 Томми-ган (SMG)',
  'weapon.thomson.desc': 'Автомат. Дает 25% к успеху и предотвращает потерю 18 HP. Требуется звание «Капо».',
  'weapon.ak47.name': '⚙️ АК-47 (Калашников)',
  'weapon.ak47.desc': 'Тяжелое боевое оружие. Дает 32% к успеху и предотвращает потерю 25 HP. Требуется звание «Дон».',

  'armor.jacket.name': '🧥 Кожаная куртка',
  'armor.jacket.desc': 'Базовая защита. Предотвращает потерю 8 HP при нападении.',
  'armor.vest.name': '🦺 Кевларовый бронежилет',
  'armor.vest.desc': 'Средняя защита. Предотвращает потерю 20 HP. Требуется звание «Бандит».',
  'armor.heavy.name': '🛡️ Тяжелая броня',
  'armor.heavy.desc': 'Максимальная защита. Предотвращает потерю 35 HP. Требуется звание «Мафиози».',
...
const HY = {
  ...
  // ── Edit Profile Modal ────────────────────────────────
  'modal.editProfile':    '✏️ Խmbagrel Иm эjый',
  'modal.avatarBgColor':  'Ֆոնային նկарի гуyny',
  'modal.avatarClick':    'Sêjmек аватари vra нkary fохeli hамар',
  'modal.nickLabel':      'Мaкануn (Nickname)',
  'modal.nickPh':         'Ձеr мaкануny',
  'modal.bioLabel':       'Карч кensagrutʼyun',
  'modal.bioPh':          'Инч-or бан dzer масин...',
  'modal.cancel':         'Чetarkel',
  'modal.save':           'Пахпанел',

  // ── Friend Profile Modal ──────────────────────────────
  'modal.friendProfile':  '👤 Wnkeroj Profily',

  // ── Search & Friends ──────────────────────────────────
  'friends.searching':    'Оронvum е...',
  'friends.notFound':     'Воч ок чи gtnвел',
  'friends.results':      'Ardyunkner',
  'friends.removeTip':    'Hеrацнел ønkerojy',
  'friends.online':       'Оnlayn',
  'friends.accept':       'Əndunел',
  'friends.decline':      'Мerjhел',

  // ── Chat ──────────────────────────────────────────────
  'chat.loading':         'Бернвum е...',
  'chat.noMessages':      'Хaghordagrut\'yunner chkan. Грел аrajin!',
  'chat.offline':         'Оֆlayn',

  // ── Auth errors ───────────────────────────────────────
  'auth.err.nameShort':   'Ануны petq е лини аrnazkayr 2 ниш',
  'auth.err.emailInvalid':'Мutqаgrek вавер ел. хасце',
  'auth.err.passShort':   'Гайtnaбары petq е лини аrnazkayr 6 ниш',
  'auth.err.passMatch':   'Гайtnaбарерy чен hамənknum',
  'auth.err.fillAll':     'Лрацrek болор дашtеры',
  'auth.ok.registered':   'Гранцумy хаджохвec! Бари галuст, ',
  'auth.ok.welcome':      'Бари галuст, ',
  ...
  'quest.reward':    'Паргев',
  'quest.done':      '✅ Катарваğ е',
  'quest.claim':     '🎁 Станал $',
  'quest.claimed':   '📜 Аrajаdrankы катарваğ е: +$',
  'notif.quests_refresh': '📋 Орva нор аrajаdranknerы:',

  // ── Events ────────────────────────────────────────────
  'event.rain':      '🌧️ Уjеği андзрев: Ханцагорцуtyunери riskы нвазел е остиканutyan пасivutyan патjaров:',
  'event.crypto':    '📈 Кriptoшукан акtivацавав: Гнери татанumnер:',
  'event.gift':      '🎁 Qез чanачецin поğосum орпес «лав тgha»: +$200',
  'event.raid':      '👮 Остиканакан рейd шрjанum:',
  'notif.arrested2': '👮 Рейd: Бrinaграваvec $500',

  // ── Map ───────────────────────────────────────────────
  'map.noBusinesses': 'Бizнес dер чунек:',
  'map.openBiz':      'Бацел →',
  'map.playerLabel':  'Дu',
  'map.legend.bank':       '🏦 Բanк',
  'map.legend.prison':     '🔒 Бант',
  'map.legend.hospital':   '🏥 Хiванданоц',
  'map.legend.casino':     '🎰 Казино',
  'map.legend.bizmarket':  '🏢 Шука',

  // ── Dealership filter dropdowns & render strings ──────
  'dealer.filterAll':    'Болор тесакнерy',
  'dealer.filterSedan':  'Седан',
  'dealer.filterSuv':    'Аменагнац',
  'dealer.filterSport':  'Спортаин',
  'dealer.sortDefault':  'Соворакан',
  'dealer.sortAsc':      'Гины ↑',
  'dealer.sortDesc':     'Гины ↓',
  'dealer.noFound':      'Воч ми мекена чgtnвец',
  'dealer.badge.new':    'НОР',
  'dealer.cond':         'Вич.:',
  'dealer.viewBtn':      'Дitел',
  'dealer.closeBtn':     'Факел',
  'dealer.buyBtn':       'Гнел',
  'dealer.bought':       '🚗 Гнецик: ',

  // ── Dealer — Car types & Spec abbreviations ───────────
  'dealer.type.sport':    'Спортаин',
  'dealer.type.sedan':    'Седан',
  'dealer.type.suv':      'Аменагнац',
  'dealer.spec.hp':       'дz.у.',
  'dealer.spec.kmh':      'км/ж',
  'dealer.spec.sec':      'в',
  'dealer.spec.topSpeed': 'В.арагц.',
  'dealer.spec.auto6':    '6-ф. авт.',
  'dealer.spec.auto8':    '8-ф. авт.',
  'dealer.spec.mech6':    '6-ф. мех.',
  'dealer.spec.fullPkg':  'Ф. арт. л.',
  'dealer.spec.carbon':   'Carbon хат.',
  'dealer.spec.seats':    'тех',
  'dealer.spec.newKm':    '0 км',
  'dealer.spec.km':       'км',
  'dealer.spec.cond':     'М.С.',

  // ── Estate ───────────────────────────────────────────
  'estate.filterAll':       'Болор тесакнеры',
  'estate.type.house':      'Тун',
  'estate.type.land':       'Ħoğ',
  'estate.type.garage':     'Автотнак',
  'estate.title.apartment': 'Бнакаран',
  'estate.title.land':      'Ħoğат.',
  'estate.title.garage':    'Автотнак',
  'estate.title.location':  '(Кент./Шрj.)',
  'estate.desc.apartment':  'Геразанч бнакаран варди hамар.',
  'estate.desc.land':       'Беркатu ħoğатарацk.',
  'estate.desc.garage':     'Каре, апахов автотнак.',
  'estate.notFound':        'Чgtnвец',
  'estate.rentPer10s':      'В/10в:',
  'estate.viewBtn':         'Дител',
  'estate.empty':           'Гуйк чка',
  'estate.unrent':          'Hанел варdzакалутyуниц',
  'estate.rent':            'Тал варdzов',
  'estate.typeLabel':       'Тесак:',
  'estate.incomeLabel':     'Екамут (вардз):',

  // ── Garage UI ─────────────────────────────────────────
  'garage.marketPrice': 'Шукаякан гин:',
  'garage.crimeCar':    '✅ Ханц. Мекена',
  'garage.makeCrime':   '🚔 Дарцнел Ханц.',
  ...
  // ── Map ──────────────────────────────────────────────
  'map.desc':            'Кağи вра тесном ес кo шрjанnerы, бizнесnerы у каревор вайреры.',
  ...
  // ── Rank modal ────────────────────────────────────────
  'rank.title':    '⭐ Кочumnер',
  'rank.current':  'Неркаин:',
  'rank.progress': 'Аrajnthaц',
  'rank.all':      'Болор Кочumnerы',
  'rank.max':      'XP (Макс.)',

  // ── Messages ─────────────────────────────────────────
  'msg.header':       'Xaghordagrut\'yunner',
  'msg.loadingList':  'Бернвум е...',
  'msg.selectFriend': 'Ентрек ынкероджы грелu hамар',
  'msg.inputPh':      'Грел hağordagrut\'yun...',
  'msg.sendTitle':    'Уğарел',

  // ── Families render ───────────────────────────────────
  'fam.invite.hdr':      '🏰 Yntanekain Hraver',
  'fam.invite.body':     ' yntaniqy hravel е kez (Boss: ',
  'fam.invite.accept':   '✓ Kamel',
  'fam.invite.decline':  '✕ Морjvel',
  'fam.create.title':    'Stvор 6-rd Yntaniqy',
  'fam.create.req':      'Pahanjаnvum е <b style="color:var(--accent);">Мафиоз</b> + <b style="color:var(--ok);">$250,000</b>',
  ...
  // ── Missing notification keys ─────────────────────────
  'notif.garage_full2':  'Автотнакы лику е',
  'notif.no_money':      'Анбавар мijocner',
  'notif.insufficient':  'Банкаин hашвин анбавар мijocner',

  // ── New keys (added) ──────────────────────────────────
  'mob.settings': 'Карgавorumnер',
  'mob.logout': 'Ехк (Logout)',
  'mob.more': 'Авелин',
  'section.explore': 'Хетахузум',
  'log.title': 'Матян',
  'btn.close': 'Факел',
  'dealer.modal.title': 'Автосрах',
  'estate.modal.title': 'Анширж гуйк',
  'fp.remove': 'Херацнел',
  'map.legend.you': 'Ду',
  'map.legend.strip': 'Стрiп акумб',
  'map.legend.ammunation': 'Зенки ханут',
  'map.legend.airport': 'Одаnavакаян',
  'biz.max_level': 'Максимум',
  'biz.per_10s': '/10в',
  'inv.already_owned': '✅ Гнваc',
  'inv.rank_required': '🔒 Пахanjvanум е՝ {rank}',
  'btn.sell_short': 'В.',
  'leaderboard.you': 'Дук (Хğацoğ)',
  'chat.online': 'Оnlayn',
  'map.label.hospital': 'Хiванданоц',
  'map.label.prison': 'Бант',
  'map.label.bank': 'Банк',
  'map.label.casino': 'Казино',
  'map.label.ammunation': 'Зенки ханут',
  'map.label.garage': 'Автотнак',
  'map.label.airport': 'Одаnavакаян',
  'map.label.gym': 'Марзасрах',
  'map.label.police': 'Остиканутyun',
  'map.label.strip': 'Стрiп акумб',

  // ── Extra coverage keys ─────────────────────────────────────
  'confirm.logout':         'Елe՞л hашв:',
  'confirm.delete':         '⚠️ Джнджел dzer профилн:',
  'confirm.reset':          '🗑️ Инчел адж аrajnthacy:',
  'confirm.remove_friend':  'Хераcнел ынкерogy:',
  'fam.boss_label':         'Босс:',
  'fam.terr_label':         'Тарацк:',
  'npc.family.suffix':      ' Yndaniq',
  'biz.none':               'Бизнес чка',
  'chat.empty_preview':     'Хagh. чка',
  'chat.no_friends':        'Авлацрек ynkerner нахорд!',
  'chat.contacts_err':      'Кapи чен hастатвел.',
  'chat.just_now':          'Хмчапер',
  'friend.removed':         'Ынкерн jнjвец',
  'mob.map':                'Qaghу Карт.',
  'mob.daynight':           'Гиш./Церед',
  'mob.events':             'Ираd-нер',
  'mob.stats':              'Wich-utyun',
  'mob.dd.profile':         'Im Profily',
  'mob.dd.settings':        'Karqavorumner',
  'mob.drawer.hdr':         'Болор Баjиnnery',
  'slots.sorry':            'Афсоc, krknek',
  'daily.activity':         'Орекан bоnus +$100',
  'preloader.s1':           'Бернdum...',
  'preloader.s2':           'Кarq prastvel...',
  'preloader.s3':           'Патраст е',
  'confirm.leave_family':   'Лкve՞l yntaniqic:',
  'main.estate.unit':       'оbj.',
  'friends.loading':        'Բеռнвum е...',
  'friends.connError':      'Капы hнаваr чe hастатвел.',
  'friends.emptyList':      'Wnkернери цанkы датарк е. Gtek у авлацрек wnkerner.',
  'notif.fam_created':      '🏰 Ынтаникy хаjохутyамб hимнадрвец:',
  'notif.fam_power_up':     '💪 Ынтаники уjы дарцав:',
  'notif.fam_new_member':   '👤 Нор андам миацав. Ынд hанур:',
  'notif.fam_kicked':       '👤 Андамы херацвец ынтаникиц:',

  // ── Weapons & Armor ───────────────────────────────────
  'weapon.knife.name': '🔪 Даnak',
  'weapon.knife.desc': 'Fog олоцаин хімнакан zenk. Барdzацнум е hаjолутyuny 5%-ов.',
  'weapon.pistol.name': '🔫 Атрчанак (Макаров)',
  'weapon.pistol.desc': 'Стандарт атрчанак. Талум е 10% hаjолутyun у кангум 5 HP kорuст.',
  'weapon.revolver.name': '🔫 Ревolver',
  'weapon.revolver.desc': 'Цанак ревolver. Талум е 15% hаjолутyun у кангум 8 HP kорuст.',
  'weapon.shotgun.name': '💥 Hрацан (Shotgun)',
  'weapon.shotgun.desc': 'Карч тарацутyан вра hзор zenk. Талум е 18% hаjолутyun у кангум 12 HP kорuст.',
  'weapon.thomson.name': '🔫 Томсон (SMG)',
  'weapon.thomson.desc': 'Ентавор zenk. Талум е 25% hаjолутyun у кангум 18 HP kорuст. Пахanjvanум е «Капо» кочум.',
  'weapon.ak47.name': '⚙️ АК-47 (Калашников)',
  'weapon.ak47.desc': 'Цанак марtакан zenk. Талум е 32% hаjолутyun у кангум 25 HP kорuст. Пахanjvanум е «Дон» кочум.',

  'armor.jacket.name': '🧥 Кашве baчkон',
  'armor.jacket.desc': 'Хімнакан pашtpанутyun. Кангум е 8 HP kорuст hарdzакumnери jамаnak.',
  'armor.vest.name': '🦺 Кевларе зрахабач kон',
  'armor.vest.desc': 'Мijин pашtpанутyun. Кангум е 20 HP kорuст. Пахanjvanум е «Авазак» кочум.',
  'armor.heavy.name': '🛡️ Цанак мартакан зрах',
  'armor.heavy.desc': 'Аравелагуйн pашtpанутyun. Кангум е 35 HP kорuст. Пахanjvanум е «Мафиоз» кочум.',

  // ── Territory keys ────────────────────────────────────
  'fam.terr.north':  'Хiусисаин Таğамас',
  'fam.terr.center': 'Кентракан Таğамас',
  'fam.terr.east':   'Аревелян Таğамас',
  'fam.terr.west':   'Аревмтян Таğамас',
  'fam.terr.south':  'Харавайн Таğамас',

  // ── Quest desc keys (for dynamic re-translation) ──────
  'quest.1.desc': '🎯 Катарел 3 ханцагорцуtyun',
  'quest.2.desc': '🚗 Гоханал 1 мекена',
  'quest.3.desc': '💰 Вастакел $1500 пасiv екамut',
